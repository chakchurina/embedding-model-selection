...
В этой статье мы представим несколько подходов к качественной оценке эмбеддинг-моделей, которые можно принять даже в отсутствие данных. Мы рассмотрим некоторые аспекты поведения векторных представлений, которые помогут сделать выбор с опорой на специфику вашего проекта.
...
На самом деле модели могут быть любыми, так наша цель — показать подходы к оценке. Вот какие модели мы использовали:
