...
4. **Jina** в прошлом тесте показывала среднее значение для релевантных текстов около 0.6. Модель хорошо справилась с терминами "fatigue", "cystinuria" и "delstrigo", но показывает низкие скоры для почти половины других терминов, включая "patient", "pregnancy" и "transfusions".
