...
Для эффективного поиска эмбеддинги запросов должны отражать их семантическую близость. Основная гипотеза: модель должна располагать похожие по смыслу запросы в векторном пространстве рядом друг с другом, то есть, 
